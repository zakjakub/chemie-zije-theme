...
module.exports = {
  // Project Identity
  appName: 'chemieZijeTheme', // Unique name of your project
  type: 'theme', // Plugin or theme
  pluginPath: 'theme',
  slug: 'chemie-zije-theme', // Plugin or Theme slug, basically the directory name under `wp-content/<themes|plugins>`
  // Used to generate banners on top of compiled stuff
  bannerConfig: {
    name: 'chemieZijeTheme',
    author: 'Jakub ZAK',
    license: 'UNLICENSED',
    link: 'UNLICENSED',
    version: pkg.version,
